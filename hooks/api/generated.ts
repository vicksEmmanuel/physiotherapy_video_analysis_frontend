...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    InsertOrUpdateUsers(variables: InsertOrUpdateUsersMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<InsertOrUpdateUsersMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<InsertOrUpdateUsersMutation>(InsertOrUpdateUsersDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'InsertOrUpdateUsers', 'mutation');
    },
    checkIfUserExist(variables?: CheckIfUserExistQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CheckIfUserExistQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CheckIfUserExistQuery>(CheckIfUserExistDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'checkIfUserExist', 'query');
    }
  };
}
